...
export const AiCard: React.FC<AiCardProps> = ({ 
    ...
    const [selectedCorrection, setSelectedCorrection] = useState<string>(initialDocClassification || 'Non Arrhythmia');
    ...
    useEffect(() => {
        ...
        setSelectedCorrection(initialDocClassification || 'Non Arrhythmia');
    ...
    const executeDelete = async () => {
        ...
        try {
            ...
            if (!error) {
                ...
                setDocNote('');
                setSelectedCorrection('Non Arrhythmia');
                if (onValidationSuccess) {
                    onValidationSuccess({
                        confirmation: null,
                                            ...
                                            {verificationState === 'incorrect' && (
                                                <div className="w-full max-w-[240px] mb-5">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        >
                                                            <option value="Non Arrhythmia">Non Arrhythmia</option>
