    ...
    return (
        <>
            ...
            <aside id="main-sidebar" className={`
                ...
                md:fixed md:top-0 md:h-screen md:w-[260px] md:bg-white md:border-r md:border-clinical-charcoal/5 md:translate-y-0 md:flex md:rounded-none md:shadow-none
