...
export const MonitorPage: React.FC = () => {
    ...
    const {
        ...
        prediction, deviceId, sessionId, stressTest, createdAt, system, network, rawClassification
    } = useECGStream(WS_URL);
    ...
    const handleToggleRecord = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/api/devices/${displayDeviceId}/command`, {
                method: 'POST',
